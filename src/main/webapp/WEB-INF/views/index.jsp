...
<head>
    ...
    <title>솔소리 푸드 트럭 beta</title>
    <link rel="shortcut icon" href="/static/images/indexfavicon.ico">
...
<section class="main">
    <header>
        <div class="wrap">
            <div class="logo">
                    <img src="/static/images/logo.png" width="120" height="52" alt="SPORTHERE, YOUR SPORT DASHBOARD">
                <a href="/">
                </a>
            </div><!-- logo -->
        </div><!-- wrap -->
    ...
    <section class="promo">
        <div class="wrap">
            ...
            <img src="/static/images/index/promo.png" width="333" height="551" alt="">
        </div><!-- wrap -->
    </section><!-- promo -->
        ...
        <div class="wrap">
            <div class="tab">
                ...
                <div class="box visible">
                    ...
                    <img src="/static/images/index/tabs.png" width="437" height="459" alt="">
                </div><!-- box -->
                <div class="box">
                    <div class="box-text">
                        <h3>The easiest way to show off your best apps</h3>
    ...
    <footer>
        <div class="wrap">
            <div class="logo">
                <a href="#">
                    <img src="/static/images/index/logo-min.png" width="64" height="52" alt="SPORTHERE, YOUR SPORT DASHBOARD">
                </a>
            </div><!-- logo -->
            <div class="istore"><a href="#">Available in Apple Store</a></div>
            <div class="copy">
                <p>Copyright &copy; 2015 <a href="#">Choi Joung Young</a></p>
            </div><!-- copy -->
            <div class="social">
                <ul class="clearfix">
